...
//    public static EntityManager em = emf.createEntityManager();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CarRepository repository = ctx.getBean(CarRepository.class);
         ...
         repository.save(new Car(1L, "Porsche 911", 
                                WorkoutType.Coupe, 
        ...
        repository.save(new Car(2L, "2014 Nissan Titan King Cab, 4x2, SV", 
                                ...
                                "Zhehai@gmail.com", 
                                "Zhehai"));
        repository.save(new Car(3L, "2014 Porsche Panamera", 
                                WorkoutType.Sedan, 
         ...
         repository.save(new Car(4L, "2015 Porsche Cayenne", 
                                WorkoutType.SUV, 
                                ...
                                "WilliamWang@qq.com", 
                                "William"));    
        repository.save(new Car(5L, "Chevrolet Corvette Z06", 
                                WorkoutType.Coupe, 
                                ...
                                "SatoChen@gamil.com", 
                                "Sato"));
        repository.save(new Car(6L, "Land Rover Range Rover Sport Supercharged", 
                                WorkoutType.SUV, 
                                ...
                                "SatoChen@yahoo.com", 
                                "Sato"));
        repository.save(new Car(7L, "2005 Ford GT", 
                                WorkoutType.SUV, 
                                ...
                                "AmyM1998@gmail.com", 
                                "Amy"));
        repository.save(new Car(8L, "1998 Porsche 911 Carrera", 
                                ...
                                "Helen"));
        repository.save(new Car(9L, "2010 Ferrari California", 
                                WorkoutType.Convertible, 
                                ...
                                "Anne"));
        repository.save(new Car(10L, "2011 Chevrolet Camaro SS", 
                                WorkoutType.Coupe, 
                                ...
                                "AdamShul@gmail.com", 
                                "Adam"));
        repository.save(new Car(11L, "2006 Buick Terraza 4dr CXL AWD", 
                                WorkoutType.Van, 
